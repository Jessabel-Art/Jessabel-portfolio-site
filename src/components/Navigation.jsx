...
const Navigation = () => {
  ...
  return (
    ...
    >
      {/* Background strip that matches site color and fades out on scroll */}
      <div
        aria-hidden
        ...
        style={{
          ...
          borderBottom: scrolled ? '1px solid transparent' : '1px solid rgba(0,0,0,.06)',
          pointerEvents: 'none',
        }}
      />
