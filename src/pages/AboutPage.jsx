...
// Warm brown body text color (matches your CSS var)
...
// Journey (use your real milestones; kept from your prior content)
const journey = [
    ...
    <div className="py-20 space-y-24 md:space-y-32">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
          <motion.div {...fadeIn} className="lg:col-span-3 space-y-7">
            <h1
              className="
            ...
            <p className="text-xl leading-relaxed" style={{ color: WARM_BROWN }}>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button asChild size="lg" className="font-semibold text-white shadow-lg
              ...
              {/* Swap href for your real resume file */}
          ...
          <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.1 }} className="lg:col-span-2">
            <img
      ...
      {/* STORY (short + credible) + EDUCATION */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <motion.div {...fadeIn} className="space-y-5">
            <h2 className="text-3xl md:text-4xl font-bold text-[hsl(var(--foreground))]">
              A practical path into UX
            </h2>
            <p className="text-lg leading-relaxed" style={{ color: WARM_BROWN }}>
          ...
          <motion.div {...fadeIn} transition={{ ...fadeIn.transition, delay: 0.1 }}>
            ...
            <ul className="space-y-2">
              {education.map((e) => (
                <li key={`${e.school}-${e.year}`} className="flex items-baseline gap-2" style={{ color: WARM_BROWN }}>
                  <span className="font-semibold text-[hsl(var(--foreground))]">{e.school}</span>
                  <span>— {e.degree} <span className="opacity-80">({e.year})</span></span>
                </li>
              ))}
            </ul>
          </motion.div>
      ...
      <section className="py-16 bg-cover bg-center relative" style={{ backgroundImage: `url(${toolsStatsBg})` }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2 {...fadeIn} className="text-3xl md:text-4xl font-extrabold text-center mb-8"
      ...
      {/* UX JOURNEY (recruiter‑scan friendly + bigger year pill + contrast) */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div {...fadeIn} className="relative space-y-12">
          ...
          {journey.map((item, index) => (
            <div key={`${item.year}-${item.title}`} className="relative pl-10 md:pl-14">
              ...
              <div className="rounded-2xl p-6 bg-[hsl(var(--card))] border border-[hsl(var(--border))] shadow-md hover:shadow-lg transition-shadow">
                {/* BIGGER YEAR PILL */}
      ...
      {/* CTA: Process (uses hero font + undershadow) */}
      <section className="py-20 bg-cover bg-center relative" style={{ backgroundImage: `url(${processBg})` }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div {...fadeIn} className="mx-auto max-w-3xl">
            ...
            <Button asChild size="lg" className="rounded-full px-6 font-semibold text-white shadow-lg
              bg-[linear-gradient(135deg,var(--btn-pink,#ff3ea5),var(--btn-teal,#00c2b2))]">
...
const ProofChip = ({ icon, label, sub }) => (
  <li className="rounded-xl px-3 py-3 border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm flex items-start gap-2">
